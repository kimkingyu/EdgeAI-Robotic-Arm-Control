...
module attributes {edge.height = 5 : i64, edge.semantic_version = "linear_half_pixel_q11_v1", edge.width = 7 : i64} {
  func.func @edge_resize_color_impl(%arg0: memref<?x?x3xi8, strided<[?, 3, 1]>>, %arg1: memref<5x7x3xi8>) attributes {edge.height = 5 : i64, edge.semantic_version = "linear_half_pixel_q11_v1", edge.width = 7 : i64, llvm.emit_c_interface} {
    ...
    ^bb0(%arg2: index, %arg3: index, %arg4: index):
      ...
      %6 = arith.muli %c2_i64, %5 : i64
      %7 = arith.addi %6, %c1_i64 : i64
      %8 = arith.muli %7, %1 : i64
      ...
      %27 = arith.index_cast %arg3 : index to i64
      %28 = arith.muli %c2_i64_3, %27 : i64
      %29 = arith.addi %28, %c1_i64_2 : i64
      ...
      %35 = arith.muli %34, %c2048_i64_4 : i64
      %36 = arith.addi %35, %c7_i64 : i64
      %37 = arith.floordivsi %36, %c14_i64 : i64
      %38 = arith.subi %c2048_i64_4, %37 : i64
      %39 = arith.addi %32, %c1_i64_2 : i64
      %40 = arith.subi %2, %c1_i64_2 : i64
      %41 = arith.maxsi %32, %c0_i64_1 : i64
      %42 = arith.minsi %41, %40 : i64
      %43 = arith.index_cast %42 : i64 to index
      %44 = arith.maxsi %39, %c0_i64_1 : i64
      %45 = arith.minsi %44, %40 : i64
      %46 = arith.index_cast %45 : i64 to index
      %47 = arith.trunci %38 : i64 to i32
      %48 = arith.trunci %37 : i64 to i32
      %extracted = tensor.extract %0[%21, %43, %arg4] : tensor<?x?x3xi8>
      %49 = arith.extui %extracted : i8 to i32
      %extracted_5 = tensor.extract %0[%21, %46, %arg4] : tensor<?x?x3xi8>
      %50 = arith.extui %extracted_5 : i8 to i32
      %extracted_6 = tensor.extract %0[%24, %43, %arg4] : tensor<?x?x3xi8>
      %51 = arith.extui %extracted_6 : i8 to i32
      %extracted_7 = tensor.extract %0[%24, %46, %arg4] : tensor<?x?x3xi8>
      %52 = arith.extui %extracted_7 : i8 to i32
      %53 = arith.muli %49, %47 : i32
      %54 = arith.muli %50, %48 : i32
      %55 = arith.addi %53, %54 : i32
      %56 = arith.muli %51, %47 : i32
      %57 = arith.muli %52, %48 : i32
      %58 = arith.addi %56, %57 : i32
      %59 = arith.muli %55, %25 : i32
      %60 = arith.muli %58, %26 : i32
      %61 = arith.addi %59, %60 : i32
      %c2097152_i32 = arith.constant 2097152 : i32
      %c22_i32 = arith.constant 22 : i32
      %c255_i32 = arith.constant 255 : i32
      %62 = arith.addi %61, %c2097152_i32 : i32
      %63 = arith.shrui %62, %c22_i32 : i32
      %64 = arith.minui %63, %c255_i32 : i32
      %65 = arith.trunci %64 : i32 to i8
      tensor.yield %65 : i8
    } {edge.resize = "linear_half_pixel_q11_v1"} : tensor<5x7x3xi8>
    %3 = tensor.empty() : tensor<5x7x3xi8>
    %4 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%generated : tensor<5x7x3xi8>) outs(%3 : tensor<5x7x3xi8>) attrs =  {edge.color = "bgr_to_rgb"} {
    ^bb0(%in: i8, %out: i8):
      linalg.yield %in : i8
    } -> tensor<5x7x3xi8>
    bufferization.materialize_in_destination %4 in restrict writable %arg1 : (tensor<5x7x3xi8>, memref<5x7x3xi8>) -> ()
    return
  }
}
